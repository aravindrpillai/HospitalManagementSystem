...
/*----------------------------------------------------------------------------*/    
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(839, 510));
        setResizable(false);
        ...
        jPanel1.setBounds(420, 140, 350, 260);
        ...
        jLabel2.setBounds(50, 50, 760, 60);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hospitalmanagementsystem/welcome.png"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(1, -4, 840, 520);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(username.equals(username_field.getText()) && password.equals(String.valueOf(password_field.getPassword())))
        {
